            ...
            {courses.map(c => (
              <div key={c.id} className="card flex flex-col gap-3">
                ...
                <div className="flex gap-2 flex-wrap">
                  {c.course_type === "pace_based" ? (
                    <Link href={`/creator/courses/${c.id}/calendar`} className="btn-ghost flex-1 text-center">30日カレンダー編集</Link>
                  ) : (
                    <Link href={`/creator/courses/${c.id}/curriculum`} className="btn-ghost flex-1 text-center">コースを編集</Link>
                  )}
